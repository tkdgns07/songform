		...
		<>
			<div className="flex w-full pt-7 pb-14 justify-center bottom-0 border-t border-gray-100 bg-white mt-[60px]">
				<div className="w-[1060px] flex items-center justify-start">
					...
					<p className="text-lighttext text-xs ml-[20px]">Contact : sangia070122@gmail.com</p>
					{/* <Link href={{ pathname : '/setadmin'  }} className="text-lighttext text-sm mr-[5px] hover:text-cusblue-normal duration-150">Set admin</Link> */}
					<p className="text-lighttext text-xs mr-[5px] hover:text-cusblue-normal duration-150 cursor-pointer ml-[10px]">Set admin</p>
					<a href="https://northern-slice-716.notion.site/Songchan-13d5e69f5b6980f1a9c0fd243545d2e8?pvs=4" className="ml-[10px]">
						<p className="text-lighttext text-xs hover:text-cusblue-normal duration-150">Guide Book</p>
					</a>
				</div>
			</div>
        </>
