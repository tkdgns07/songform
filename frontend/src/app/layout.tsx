      ...
      <body className={inter.className}>
        <SessionProvider>
          <div className="px-[20px] w-[100%] h-[55px] flex items-center justify-between mb-[10px] menubar">
            <Link href={{pathname: '/'}} className="ml-[0px] h-[90%] flex direction-col items-center">
          ...
          <div className="mt-[65px] w-full flex justify-center">
            {children}
          </div>
          <Toaster/>
          <div className="w-full h-[50px] bg-lighttext footbar">
          </div>
        </SessionProvider>
      </body>
    </html>
